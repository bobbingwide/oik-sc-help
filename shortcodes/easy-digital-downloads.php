...
/**
 * Shortcode help for Easy Digital Downloads shortcodes
 */
...
/*
download_checkout', 'edd_checkout_form_shortcode
*/
function download_checkout__help() {
  return( "Show the checkout form" );
}
/** 
download_cart', 'edd_cart_shortcode' );
